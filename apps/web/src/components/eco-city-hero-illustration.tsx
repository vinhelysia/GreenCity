  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="softGlow" x="380" y="20" width="100" height="100" filterUnits="userSpaceOnUse">
      ...
      <circle cx="430" cy="85" r="45" fill="url(#sunGrad)" opacity="0.85" filter="url(#softGlow)" />
